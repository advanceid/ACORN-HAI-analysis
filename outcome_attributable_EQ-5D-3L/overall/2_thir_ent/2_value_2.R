...
# Rows
rows <- list(
  c("Characteristics", NA, NA, NA, "Crude difference (95%CI)", "p.value"),
  ...
  c("Hospital-acquired BSI", results[14, c(2:4, 6, 5)]),
  c("Healthcare-associated BSI", results[15, c(2:4, 6, 5)]),
  c("Enterobacterales", NA, NA, NA, NA, NA),
  c("Third-generation cephalosporin-susceptible", NA, NA, NA, "Ref", NA),
  c("Third-generation cephalosporin-resistant", results[16, c(2:4, 6, 5)])
)
