...
rows <- list(
  ...
  c("Gastrointestinal disorder", results[5, c(2:4, 6, 5)]),
  c("Pulmonary disease", results[6, c(2:4, 6, 5)]),
  c("Others", results[7, c(2:4, 6, 5)]),
  c("Charlson comorbidity index", NA, NA, NA, NA, NA),
  c(NA, results[8, c(2:4, 6, 5)]),
  c("Severity score of disease", NA, NA, NA, NA, NA),
  c(NA, results[9, c(2:4, 6, 5)]),
  c("Admission to ICU/HD at enrollment", NA, NA, NA, NA, NA),
  c("No", NA, NA, NA, "Ref", NA),
  c("Yes", results[10, c(2:4, 6, 5)]),
  c("Type of pathogens", NA, NA, NA, NA, NA),
  c("Monomicrobial", NA, NA, NA, "Ref", NA),
  c("Polymicrobial", results[11, c(2:4, 6, 5)]),
  c("Infection syndromes", NA, NA, NA, NA, NA),
  c("VAP", NA, NA, NA, "Ref", NA),
  c("Hospital-acquired BSI", results[12, c(2:4, 6, 5)]),
  c("Healthcare-associated BSI", results[13, c(2:4, 6, 5)]),
  c("Enterobacterales", NA, NA, NA, NA, NA),
  c("Third-generation cephalosporin-susceptible", NA, NA, NA, "Ref", NA),
  c("Third-generation cephalosporin-resistant", results[14, c(2:4, 6, 5)])
)
