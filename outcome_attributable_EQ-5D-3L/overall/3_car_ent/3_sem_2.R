...
# Coef
important_vars <- c("age_new", "sex", "severity_score_scale", "icu_hd_ap", "pathogen_combined_types", "ent_car")
...
saveRDS(factor_load_eq, "data/attfbis_factor_load_3.RData")
saveRDS(S_coef_values, "data/attfbis_S_coef_3.RData")