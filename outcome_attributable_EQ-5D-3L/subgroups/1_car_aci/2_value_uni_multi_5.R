...
res4 <- readRDS("data/attfbis_value_multi_3.RData")
#
...
colnames(res) <- c("Characteristics", 
                   ...
                   "Adjusted coefficient (95%CI)_multi_vap_3", "P value_multi_vap_3",
                   "Crude coefficient (95%CI)_uni_bsi1", "P value_uni_bsi1",
                   "Adjusted coefficient (95%CI)_multi_bsi1_1", "P value_multi_bsi1_1",
                   "Adjusted coefficient (95%CI)_multi_bsi1_2", "P value_multi_bsi1_2")
# 
...
table <- res %>%
  ...
  cols_label(
    ...
    `Adjusted coefficient (95%CI)_multi_vap_3` = md("Adjusted coefficient (95%CI)"),
    `P value_multi_vap_3` = md("*p*"),
    ...
    `Adjusted coefficient (95%CI)_multi_bsi1_2` = md("Adjusted coefficient (95%CI)"),
  ...
  cols_width(
    1 ~ px(200),
    c(2, 4, 6, 8, 10, 12, 14) ~ px(120),
    c(3, 5, 7, 9, 11, 13, 15) ~ px(60)
  ) %>%
  tab_options(
