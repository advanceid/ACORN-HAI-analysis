...
colnames(res) <- c("Characteristics", 
                   ...
                   "Adjusted coefficient (95%CI)_multi_bsi2_3", "P value_multi_bsi2_3")
# 
...
table <- res %>%
  ...
  cols_label(
    ...
    `Adjusted coefficient (95%CI)_multi_bsi2_3` = md("Adjusted coefficient (95%CI)"),
    `P value_multi_bsi2_3` = md("*p*")
  ) %>%
  cols_align(
    align = "center",
    columns = 2:ncol(res)
  ...
  tab_style(
    ...
    locations = cells_column_spanners(spanners = c("vap",
                                                   ...
                                                   "bsi2",
                                                   "uni_bsi2",
                                                   "multi_bsi2_1", "multi_bsi2_2", "multi_bsi2_3"))
  ) 
