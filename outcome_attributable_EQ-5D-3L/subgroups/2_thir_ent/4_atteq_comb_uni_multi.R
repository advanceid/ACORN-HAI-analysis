...
groups <- c("vap_1", "vap_2",
            "bsi1_1", "bsi1_2", 
            "bsi2_1", "bsi2_2", "bsi2_3")
...
table <- res %>%
  ...
  cols_label(
    ...
    `Unstandardized coefficient (95%CI)_bsi2_3` = md("Unstandardized coefficient (95%CI)"),
    `P value_bsi2_3` = md("*p*"),
    `Standardized coefficient (95%CI)_bsi2_3` = md("Standardized coefficient (95%CI)")
  ) %>%
  cols_align(
    align = "center",
    columns = 2:ncol(res)
  ...
  cols_width(
    1 ~ px(195),
    c(2, 5, 8, 11, 14, 17, 20) ~ px(120),
    c(3, 6, 9, 12, 15, 18, 21) ~ px(50),
    c(4, 7, 10, 13, 16, 19, 22) ~ px(95)
  ) %>%
  tab_options(
  ...
  tab_style(
    ...
    locations = cells_column_spanners(spanners = c("vap", "vap_sem_1", "vap_sem_2",
                                                   ...
                                                   "bsi2", "bsi2_sem_1", "bsi2_sem_2", "bsi2_sem_3"))
  ) 
