...
for (i in 1:2){
  ...
  if (i == 1) {
    ...
    # Model 2, delete hpd_admreason, comorbidities_CCI, pathogen_combined_types
    formula <- fbis_score ~
      age_new + sex + 
      country_region + country_income +
  ...
  if (i == 1) {
    ...
    rows <- list(
      ...
      c("Acinetobacter spp.", NA, NA, NA, NA, NA),
      c("Carbapenem-susceptible", NA, NA, NA, "Ref", NA),
      c("Carbapenem-resistant", coef_df[9, c(10:13, 9)]))
  } 
