...
for (i in 1:3){
  ...
  # MODEL 
  if (i == 1) {
    # Model 1: delete comorbidities_CCI, pathogen_combined_types
    formula <- fbis_score ~
      age_new + sex + 
    ...
    # Model 3: delete country_income, hpd_admreason
    formula <- fbis_score ~
  ...
  if (i == 1) {
    rows <- list(
      ...
      c("Gastrointestinal disorder", coef_df[5, c(10:13, 9)]),
      c("Pulmonary disease", coef_df[6, c(10:13, 9)]),
      c("Others", coef_df[7, c(10:13, 9)]),
      c("Charlson comorbidity index", NA, NA, NA, NA, NA),
      c(NA, NA, NA, NA, NA, NA),
      c("Severity score of disease", NA, NA, NA, NA, NA),
      c(NA, coef_df[8, c(10:13, 9)]),
      c("Admission to ICU/HD at enrollment", NA, NA, NA, NA, NA),
      c("No", NA, NA, NA, "Ref", NA),
      c("Yes", coef_df[9, c(10:13, 9)]),
      ...
      c("Third-generation cephalosporin-resistant", coef_df[10, c(10:13, 9)])
    )
  } else if (i == 2) {
    rows <- list(
      c("Characteristics", NA, NA, NA, "Adjusted coefficient (95%CI)", "p.value"),
      ...
      c("Polymicrobial", coef_df[8, c(10:13, 9)]),
      c("Enterobacterales", NA, NA, NA, NA, NA),
      c("Third-generation cephalosporin-susceptible", NA, NA, NA, "Ref", NA),
      c("Third-generation cephalosporin-resistant", coef_df[9, c(10:13, 9)])
    )
  } else if (i == 3) {
    rows <- list(
      c("Characteristics", NA, NA, NA, "Adjusted coefficient (95%CI)", "p.value"),
      ...
      c("Severity score of disease", NA, NA, NA, NA, NA),
      c(NA, coef_df[4, c(10:13, 9)]),
      c("Admission to ICU/HD at enrollment", NA, NA, NA, NA, NA),
      c("No", NA, NA, NA, "Ref", NA),
      c("Yes", coef_df[5, c(10:13, 9)]),
      c("Type of pathogens", NA, NA, NA, NA, NA),
      c("Monomicrobial", NA, NA, NA, "Ref", NA),
      c("Polymicrobial", coef_df[6, c(10:13, 9)]),
      c("Enterobacterales", NA, NA, NA, NA, NA),
      c("Third-generation cephalosporin-susceptible", NA, NA, NA, "Ref", NA),
      c("Third-generation cephalosporin-resistant", coef_df[7, c(10:13, 9)])
    )
  }
...
# Save table
saveRDS(result_save, "data/attfbis_table_multi_1.RData")
