...
# Combine
res1 <- readRDS("data/attfbis_table_univariable_sub.RData")
res2 <- readRDS("data/attfbis_table_multi_1_sub.RData")
res3 <- readRDS("data/attfbis_table_multi_2_sub.RData")
