...
# Save
image_write(final_image_1, path = "output/pdf/com_att28_KM_1to3_infection.pdf", format = "pdf")
image_write(final_image_2, path = "output/pdf/com_att28_KM_4to6_infection.pdf", format = "pdf")
