...
system.time({
  for (i in 1:3) {
    ...
    # x.factors
    if (i == 1) {
      # For factors, delete country_income, hpd_admreason, comorbidities_CCI, severity_score_scale, icu_hd_ap
      ...
      x.factors <- model.matrix(~ df$sex + 
                                  ...
                                  df$hpd_admreason + df$comorbidities_CCI + df$icu_hd_ap +
                                  df$aci_car + df$ent_thir + df$ent_car)[,-1]
      ...
      # For factors, delete country_region, hpd_admreason, severity_score_scale
      x.factors <- model.matrix(~ df$sex + 
                                  df$country_income +
    ...
    if (i == 1) {
      ...
      rows <- list(
        ...
        c("Gastrointestinal disorder", df_used[6, c(2:6)]),
        c("Pulmonary disease", df_used[7, c(2:6)]),
        c("Others", df_used[8, c(2:6)]),
        c("Charlson comorbidity index", NA, NA, NA, NA, NA),
        c(NA,df_used[9, c(2:6)]),
        c("Severity score of disease", NA, NA, NA, NA, NA),
        c(NA, df_used[15, c(2:6)]),
        c("Admission to ICU/HD at enrollment", NA, NA, NA, NA, NA),
        c("No", NA, NA, NA, "Ref", NA),
        c("Yes", df_used[10, c(2:6)]),
        c("Carbapenem-resistant Acinetobacter spp.", NA, NA, NA, NA, NA),
        c("Absent", NA, NA, NA, "Ref", NA),
        c("Present", df_used[11, c(2:6)]),
        c("Third-generation cephalosporin-resistant Enterobacterales", NA, NA, NA, NA, NA),
        c("Absent", NA, NA, NA, "Ref", NA),
        c("Present", df_used[12, c(2:6)]),
        c("Carbapenem-resistant Enterobacterales", NA, NA, NA, NA, NA),
        c("Absent", NA, NA, NA, "Ref", NA),
        c("Present", df_used[13, c(2:6)])
      )
    } else if (i == 3) {
      rows <- list(
        c("Characteristics", NA, NA, NA, "Adjusted HR (95%CI)", "p.value"),
        ...
        c("Others", NA, NA, NA, NA, NA),
        c("Charlson comorbidity index", NA, NA, NA, NA, NA),
        c(NA,df_used[4, c(2:6)]),
        c("Severity score of disease", NA, NA, NA, NA, NA),
        c(NA, NA, NA, NA, NA, NA),
        c("Admission to ICU/HD at enrollment", NA, NA, NA, NA, NA),
        c("No", NA, NA, NA, "Ref", NA),
        c("Yes", df_used[5, c(2:6)]),
        c("Carbapenem-resistant Acinetobacter spp.", NA, NA, NA, NA, NA),
        c("Absent", NA, NA, NA, "Ref", NA),
        c("Present", df_used[6, c(2:6)]),
        c("Third-generation cephalosporin-resistant Enterobacterales", NA, NA, NA, NA, NA),
...
# Save
saveRDS(result_save, "data/recur_table_multivariable_1.RData")
###
